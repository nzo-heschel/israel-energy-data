...
NS_LABEL_POST_MAP = {
    ...
    "energy": {  # production mix
        ...
        "discharge_PV_BESS": "PV With Storage",
        "total_Renewables": "Renewable Sum",
        "pump_Gen_PumpedStorage": "PSP Net",
        "discharge_PumpedStorage_and_BESS": "storage",
        "discharge_Charge_BESS": "Batteries Net",
